...
**Action:** Replace `Array.sort()` with a simple, bounded `for` loop (like insertion sort) inside high-frequency tooltip formatters to reduce GC churn and ensure smoother UI performance.

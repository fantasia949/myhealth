  ...
  ({ supplementName, onClose }: SupplementCorrelationProps) => {
    ...
    const rowElements = React.useMemo(() => {
      ...
      for (let i = 0; i < correlations.length; i++) {
        ...
        rows.push(
          <tr key={item.name} className="hover:bg-gray-800/50 transition-colors">
            <td className="py-3 px-4 text-sm font-medium text-gray-200">{item.name}</td>
            <td className="py-3 px-4 text-sm text-center text-gray-400 font-mono">{item.count}</td>
            <td
        ...
        <Dialog as="div" className="relative z-50" onClose={onClose}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
              ...
              >
                <Dialog.Panel className="w-full lg:w-1/3 transform overflow-hidden bg-[#222222] text-dark-text shadow-xl transition-all h-screen ml-auto border-l border-gray-700 flex flex-col">
                      ...
                      <div className="flex flex-col gap-8">
                        ...
                        <div className="overflow-x-auto">
                          <table className="min-w-full divide-y divide-gray-700">
                            ...
                            <tbody className="divide-y divide-gray-700">{rowElements}</tbody>
                          </table>
                        </div>
                      </div>
                    )}

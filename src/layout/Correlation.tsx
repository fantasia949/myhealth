                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-[#222222] border-l border-gray-700 shadow-xl">
                    ...
                    <div className="relative mt-2 flex-1 px-4 sm:px-6">
                      <div className="mb-4 p-3 border border-gray-700 rounded bg-dark-bg/50">
                        <div className="text-xs font-bold mb-2 text-gray-400 uppercase tracking-wider">
                          {method === 'pearson' ? 'Pearson' : 'Spearman'} Correlation Settings
                        </div>
                        <div className="flex flex-col gap-2">
                          <div className="flex justify-between items-center">
                            <label htmlFor="corr-method" className="text-xs text-gray-300">
                              Method:
                            </label>
                            <select
                              id="corr-method"
                          ...
                          <div className="flex justify-between items-center">
                            <label htmlFor="corr-alpha" className="text-xs text-gray-300">
                              Alpha Threshold:
                            </label>
                            <select
                              id="corr-alpha"
                          ...
                          <div className="flex justify-between items-center">
                            <label htmlFor="corr-alt" className="text-xs text-gray-300">
                              Hypothesis:
                            </label>
                            <select
                              id="corr-alt"

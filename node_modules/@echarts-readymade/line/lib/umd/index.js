(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.EchartsReadymadeLine = {}, global.React, global.Big, global.echarts));
  ...
  ***************************************************************************** */
  ...
  const Line = React.forwardRef((props, ref) => {
            ...
            _seriesValueList.push({
              ...
              data: _data2.map((d) => {
                if (d[v.fieldKey] !== null && typeof d[v.fieldKey] !== "undefined" && !isNaN(d[v.fieldKey])) {
                  let result = Big__default["default"](d[v.fieldKey]);
                  if (v.isPercent) {
    ...
    return /* @__PURE__ */ React__default["default"].createElement(EChartsReact, __spreadValues({
      ref: (e) => {

(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('big.js'), require('echarts')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'big.js', 'echarts'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.EchartsReadymadeScatter = {}, global.React, global.Big, global.echarts));
})(this, (function (exports, React, Big, echarts) { 'use strict';
  ...
  ***************************************************************************** */
  ...
  var EChartsReactCore = /** @class */ (function (_super) {
      ...
      EChartsReactCore.prototype.render = function () {
          ...
          return (React__default["default"].createElement("div", { ref: function (e) {
                  _this.ele = e;
  ...
  const Scatter = React.forwardRef((props, ref) => {
    const _a = props, {
      context,
      dimension,
      compareDimension,
    ...
    const { data, echartsOptions, echartsOptionsBase: chartOption, userOptions } = React.useContext(context);
    ...
    const [dataZoomX, setDataZoomX] = React.useState(null);
    const [dataZoomY, setDataZoomY] = React.useState(null);
    if (_chartOption) {
      if (compareDimension && compareDimension.length > 0) {
        ...
        const getSymbolSize = React.useCallback((dotValue) => {
          const scale = _valueList.length === 3 ? Big__default["default"](dotValueMax - dotValueMin).div(maxSymbolSize - minSymbolSize).toNumber() || 1 : 1;
          return _valueList.length === 3 ? Big__default["default"](dotValue - dotValueMin).div(scale).plus(minSymbolSize).round(2).toNumber() : 80;
        }, [getColor]);
            ...
            let _value = [
              ..._valueList.map((v) => {
                ...
                if (d[v.fieldKey] != null) {
                  _v = Big__default["default"](d[v.fieldKey]);
                  if (v.isPercent) {
                    _v = _v.times(100);
                  }
        ...
        _processData == null ? void 0 : _processData.forEach((item) => {
          item.data.forEach((d) => {
            xMin = Math.min(Big__default["default"](d[_valueList[0].fieldKey] || 0).round(0).toNumber(), xMin);
            xMax = Math.max(Big__default["default"](d[_valueList[0].fieldKey] || 0).round(0).toNumber(), xMax);
            yMin = Math.min(Big__default["default"](d[_valueList[1].fieldKey] || 0).round(0).toNumber(), yMin);
            yMax = Math.max(Big__default["default"](d[_valueList[1].fieldKey] || 0).round(0).toNumber(), yMax);
          });
        });
        if (_valueList[0].isPercent) {
          xMin = Big__default["default"](xMin).times(100).toNumber();
          xMax = Big__default["default"](xMax).times(100).toNumber();
        }
        if (_valueList[1].isPercent) {
          yMin = Big__default["default"](yMin).times(100).toNumber();
          yMax = Big__default["default"](yMax).times(100).toNumber();
        }
        const _dataZoom = [];
        if (dataZoomX) {
          _dataZoom.push({
          ...
          _dataZoom.push({
            ...
            bottom: 30,
            startValue: xMin || 0,
            endValue: xMax && Big__default["default"](xMax).plus(Big__default["default"](xMax).times(0.1).abs().toNumber()).toNumber() || 100,
            throttle: 150
          });
        }
        if (dataZoomY) {
        ...
        _chartOption.xAxis.max = xMax && Big__default["default"](xMax).plus(Big__default["default"](xMax).times(0.1).abs().toNumber()).toNumber() || 100;
        _chartOption.yAxis[0].max = yMax && Big__default["default"](yMax).plus(Big__default["default"](yMax).times(0.1).abs().toNumber()).toNumber() || 100;
        _chartOption.xAxis.axisLabel.formatter = (value) => {
        ...
        const processedData = data == null ? void 0 : data.map((d) => {
          ...
          _valueList.map((v, i) => {
            if (d[v.fieldKey] != null) {
              values[i] = Big__default["default"](d[v.fieldKey]);
              if (v.isPercent) {
        ...
        const minSymbolSize = minDotSize != null ? minDotSize : 50;
        const maxSymbolSize = maxDotSize != null ? maxDotSize : 100;
        const getSymbolSize = React.useCallback((list) => {
          ...
          const scale = _valueList.length === 3 ? Big__default["default"](max - min).div(maxSymbolSize - minSymbolSize).toNumber() || 1 : 1;
          list.forEach((item, index) => {
            item[5] = _valueList.length === 3 ? Big__default["default"](item[2] - min).div(scale).plus(minSymbolSize).round(2).toNumber() : 80;
    ...
    const onDataZoomChange = React.useCallback((params) => {
    ...
    const reactEchartsRef = React.useRef(null);
    ...
    return /* @__PURE__ */ React__default["default"].createElement(EChartsReact, __spreadValues$1({
      ref: (e) => {

...
const ChartProvider = (props) => {
  ...
  return React.createElement(Provider, { value: { data, echartsOptions, echartsOptionsBase, userOptions } }, props.children);
};
...
export { COLOR_LIST, ChartContext, ChartProvider, buildChartOption, index as default, mergeOption, numberWithCommas, truncate };
